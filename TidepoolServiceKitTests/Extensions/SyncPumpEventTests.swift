...
class SyncPumpEventTests: XCTestCase {
    func testDatumAlarm() {
        ...
        let datum = pumpEvent.datum(for: "2B03D96C-6F5D-4140-99CD-80C3E64D6011")
...
"""
    ...
    func testDatumTempBasalMutable() {
        let pumpEvent = SyncPumpEvent(date: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
                                      type: .tempBasal,
                                      mutable: true,
                                      dose: DoseEntry(type: .tempBasal,
...
"""
    ...
    func testDatumTempBasalDuringSuspend() {
        let pumpEvent = SyncPumpEvent(date: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
                                      type: .tempBasal,
                                      mutable: true,
                                      dose: DoseEntry(type: .tempBasal,
